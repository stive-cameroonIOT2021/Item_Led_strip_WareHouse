...
const int pins[NUM_STRIPS] = {8, 7, 6, 5, 4, 3, 2, A0};
...
Adafruit_NeoPixel strips[NUM_STRIPS] = {
  ...
  Adafruit_NeoPixel(NUM_OF_LEDS, pins[6], NEO_GRB + NEO_KHZ800),
  Adafruit_NeoPixel(NUM_OF_LEDS, pins[7], NEO_GRB + NEO_KHZ800)
};
